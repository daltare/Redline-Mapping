...
- from CalEnviroScreen we know that, state-wide, people of color are vastly over-represented in the census tracts with the highest pollution burden / vulnerability state-wide
