...
knitr::include_graphics("images/1-map_combined.png")
```
]
...
.center[
```{r out.width = '100%', echo=FALSE}
knitr::include_graphics("images/5-race_ethnicity_plot _revised.png")
```
]
...
--
    ...
    - already know that people of color are vastly over-represented in the census tracts with the highest pollution burden / vulnerability
